...
--4.	Retrieve first 10% Loan Amounts in which their descending order.
SELECT TOP 10 PERCENT * FROM DEPOSIT
ORDER BY AMOUNT DESC

--5.	Retrieve all unique customer names with city.
SELECT DISTINCT CNAME,CITY  FROM DEPOSIT

--6.	Retrieve all Loan records with one more column in Loan Amount as 10% extra amount.
SELECT LOANNO,CNAME,BNAME,AMOUNT , AMOUNT * 0.1 AS EXTRA_AMOUNT FROM BORROW
